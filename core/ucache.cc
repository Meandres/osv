...
uCache::uCache() : totalPhysSize(0), evict_batch(0), prefetch_batch(0){
   	usedPhysSize = 0;
   	readSize = 0;
   	writeSize = 0;
		prefetchedSize = 0;
...
VMA* uCache::mmap(const char* name, u64 pageSize){
